...
def displayResult(Valuelist,FindWhat):
	if FindWhat == 1:
		print("In the points inputed by you, the maximum of distance is ",format(Valuelist[0],"10.2f"))
		print("These two points are :")
		print("Point",Valuelist[3 if Valuelist[3] < Valuelist[4] else 4]," ",Valuelist[1 if Valuelist[3] < Valuelist[4] else 2])
		print("Point",Valuelist[4 if Valuelist[3] < Valuelist[4] else 3]," ",Valuelist[2 if Valuelist[3] < Valuelist[4] else 1])
		#connectPoints()
	elif FindWhat == 2:
		print("In the points inputed by you, the minimum of distance is ",format(Valuelist[0],"10.2f"))
		print("These two points are :")
		print("Point",Valuelist[3 if Valuelist[3] < Valuelist[4] else 4]," ",Valuelist[1 if Valuelist[3] < Valuelist[4] else 2])
		print("Point",Valuelist[4 if Valuelist[3] < Valuelist[4] else 3]," ",Valuelist[2 if Valuelist[3] < Valuelist[4] else 1])
		#connectPoints()
