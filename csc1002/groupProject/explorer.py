...
# To Guest team: complete these functions. DO NOT change the function
# names. Otherwise, mazer.py can not call them.

def KeyUp(self):
    # To Guest team: complete this function. DO NOT change the function name,
    # so that mazer.py can call it.
